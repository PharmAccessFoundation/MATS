...
class Module_Users extends Module {
	...
	public function admin_menu(&$menu)
	{
		$menu['lang:cp:nav_users']['lang:cp:nav_users'] = 'admin/users';
                if($this->current_user->group_id == 9 || $this->current_user->group_id == 16 || $this->current_user->group_id == 12){
		$menu['lang:cp:nav_users']['Create New User'] = 'admin/users/srcreate';
                }else if($this->current_user->group_id == 7){
		$menu['lang:cp:nav_users']['Create New User'] = 'admin/users/prcreate';
                }else{
		$menu['lang:cp:nav_users']['Create New User'] = 'admin/users/create';
                }
	}
