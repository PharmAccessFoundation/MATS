                ...
                <div class="input form-group">
                       ...
                       <div class="input form-group">
                        <label for="code">Hub Facility Email <span>*</span></label>
                            <?php echo form_input('code',  $curr->email, 'class=form-control') ?>
                        </div>
                 ...
                 <div class="buttons">
                    <label style="padding-top: 25px"></label><?php echo anchor('/admin/programs/facility', lang('buttons:cancel'), 'class=" btn btn-danger"') ?>
