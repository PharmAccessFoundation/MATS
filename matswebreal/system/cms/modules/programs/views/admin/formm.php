...
<div class="panel panel-default" style="margin: 10px;">
    ...
    <div class="panel-body div_top_hypers" style="">
        ...
        <div class="form_inputs col-md-6" style="padding-top: 0;" id="user-basic-data-tab">
            ...
            <div class="input form-group">
                        <label for="name">Sub Recipient Type<span>*</span></label>
                            <?php echo $srlist ?>
                        </div>
                <div class="input form-group">
       ...
       <div class="input form-group">             
<label for="name">Hub Facility Address<span>*</span></label>
                   ...
                   <div class="input form-group">
                        <label for="numb">Hub Facility Phone <span>*</span></label>
                            <?php echo form_input('numb', '', 'class=form-control') ?>
                        </div>
           <!-- <div class="input form-group">
                        <label for="numb">Programme <span>*</span></label>
                        
                            <?php //echo form_dropdown('prog', $pro, array(), 'class=form-control') ; ?>
                        </div>-->
                    

                    <div class="buttons">
                        <?php $this->load->view('admin/partials/buttons', array('buttons' => array('save'))) ?>
                        <a href="admin/programs/facility" class="btn gray cancel">Cancel</a>
                    </div>
