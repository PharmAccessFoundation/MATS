...
<section class="title">
    ...
    <strong>New Linkage Coordinator</strong>
                ...
                <div class="tab-pane fade active in" id="home">
                    ...
                    <div class="form_inputs" id="user-basic-data-tab">
                        <fieldset class="col-md-6">
                            <?php if($this->current_user->group_id == 7 || $this->current_user->group_id == 9): // echo $this->current_user->sub_recipient_type; var_dump($progr); var_dump($subr); ?>
                            <div class="input form-group">
                                <label for="prog">Programme<span>*</span></label>
                                <div style="color: #0044cc; font-weight: bold;"> <?php echo strtoupper($progr); ?> </div>
                            </div>
                            <?php endif; ?>
                            <?php if($this->current_user->group_id == 9): ?>
                            <div class="input form-group">
                                <label for="subr">Sub Recipient<span>*</span></label>
                                <div style="color: #0044cc; font-weight: bold;"> <?php echo strtoupper($subr); ?></div>
                            </div>
                            <?php endif; ?>
                            <div class="input form-group">
