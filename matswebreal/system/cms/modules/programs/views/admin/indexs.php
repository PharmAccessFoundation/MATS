...
<section class="item">
    <div class="content">
            ...
            <div class="panel-body div_top_hypers " style="">
                <div class="col-md-6">
                    ...
                    ?>
                            ...
                            <?php elseif ($this->current_user->group_id == 7) : ?>

                                <li class="form-group input-group" style="float: left;">
                                    <span class="input-group-addon">Sub Recipient(s)</span>
                                    <?php echo form_dropdown('srs', array(0 => lang('global:select-all')) + $srs, array(), 'class=form-control') ?>
                                </li>
        ...
        <div id="filter-stage">
            <?php if (!empty($users)) : ?>
                <div class="panel panel-default" style="margin: 10px;">
                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover example2" id="example2">
                                <thead>
                                    <tr>
                                        <th>S/N</th>
                                        <?php if ($this->current_user->id != 622) : ?> <th>Name</th>
                                        <th>Mobile</th>
                                        <?php endif; ?>
                                        <th>Hub Facility</th>
                                ...
                                <tbody>
                                    ...
                                    foreach ($users as $member) : ?>
                                        <tr class="odd gradeX">
                                            ...
                                            <?php endif; ?>
                                            <td><?php echo str_replace(".", "", $member->name) ?></td>
                                  ...
                                  // $drpx2 = "<input type='date' name = 'xpertc".$member->sid."' value='$member->xpertdate' />";
                                    ...
                                    */
                                            ...
                                            <!--<td class=""><?php //echo (strtoupper($member->status) == 'YES') ? 'Positive' : 'Negative'  
                                                                ?></td>-->
                ...
                <div class="table_action_buttons">
                    <?php if ($this->current_user->group_id == 8) : ?>
        ...
        <?php
        session_start();
        $_SESSION['table'] = ' <table><tr><td>Cell 1111</td><td>Cell 2222</td></tr></table>';
        ?>
