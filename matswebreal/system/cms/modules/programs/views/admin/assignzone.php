...
<section class="title">
    ...
    <strong>Assign Manager To A Zone</strong>
            ...
            <div class="panel-body div_top_hypers" style="">
                ...
                <div class="form_inputs col-md-6" style="padding-top: 0;" id="user-basic-data-tab">
                    <div class="input form-group">
                        <label for="code"> Zone Details: <?php echo $zone->name; ?><span></span></label>
                        <br>
                    ...
                    <div class="form-group input-group" style="float: left;">
                        <span class="input-group-addon">Select Zonal Manager</span>
