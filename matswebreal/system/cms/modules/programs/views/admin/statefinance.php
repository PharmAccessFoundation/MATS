...
<section class="title">
    <strong>Manage State Financial Coordinator(s)</strong>
</section>
...
<section class="item">
	<div class="content">
     ...
     <?php endif; ?>
          <span style="float: right"><a href="index.php/admin/programs/createfinance" class="btn-primary">New State Financial Coordinator</a></span>
        </div>
				<?php if (!empty($users)): ?>
                        ...
                        <?php foreach ($users as $member): ?>
                            <tr class="odd gradeX" >
                                ...
                                <td class="">
                                    ...
                                    if($member->active == 0){
                                    echo anchor('admin/programs/fapprove/' . $member->id, 'Activate', array('class' => 'btn btn-primary')) ;
                                    }  else{
                                    echo anchor('admin/programs/fdapprove/' . $member->id, 'Deactivate', array('class' => 'btn btn-warning')) ;
                                    } 
                                    ...
                                    echo ' ';
                                     if($this->current_user->group_id == 7){
                                        echo anchor('admin/programs/deleteadd/' . $member->id, lang('global:delete'), array('class' => 'btn btn-danger confirm button delete'));
                                    }
                                    ?>
                                </td>
