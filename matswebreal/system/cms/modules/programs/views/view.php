...
<div class="row-fluid" style="width: auto;">
    ...
    <div class="span10 allwayTab allwayTab-left w-200" id="gmaps">
        ...
        if (@$assets != 0): ?>
            ...
            <div class="floatingBox">
                <!-- ==================== VECTOR MAPS TABS ==================== -->
                <ol class="nav nav-tabs nav-tabs-normal verticalTab">
                    ...
                    <?php endforeach; 
                    if($page != false && $assety ):
                    ?>
                        
                        <li class="">
                            <div class="pagination">
                        <?php if($c2-1 > 0):?><a href="index.php/convergy/listings/0/<?php echo $c1-1; ?>">&laquo;</a><?php endif; ?>
                        <?php if($c1-1 > 0):?><a href="index.php/convergy/listings/0/<?php echo $c1; ?>" class="active"><?php echo $c1; ?></a><?php endif; ?>
                        <a href="index.php/convergy/listings/0/<?php echo $c2; ?>" class="active"><?php echo $c2; ?></a>
                        <?php if($c3):?> <a href="index.php/convergy/listings/0/<?php echo $c3; ?>"><?php echo $c3; ?></a><?php endif; ?>
                        <?php if($c3 > 1):?><a href="index.php/convergy/listings/0/<?php echo $c3; ?>">&raquo;</a><?php endif; ?>
                        </div>
                    </li>
                    <?php endif; ?>
                </ol>
