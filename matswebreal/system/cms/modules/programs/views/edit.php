...
<script>
    function show()
    {
        ...
        if (sel == 'Airport' || sel == 'Buses' || sel == 'Taxis' || sel == 'Transit Vans' || sel == 'Mobile LED Vans') {
            ...
            if (sel == 'Billboards')
                options = ["Super 48 Sheet", "96 Sheet", "Unipoles", "Portrait", "Bulletin", "Backlit", "Bridge Panel", "Long Banner", "Wall Panel", "Inflatable", "Scrollers", "Trivision"];
            if (sel == 'Lampost')
    ...
    function show3()
    {
        ...
        if (sel == '') {
            ...
            ely.innerHTML = '';
            for (var i = 0; i < sel; i++) {
                var text = '<div class="control-group"><label class="control-label" for="address">SIDE ' + optiony[i] + ' *</label><div class="controls"><input id="address" class="span10 parsley-validated" type="text" data-minlength="1" data-required="true" data-trigger="change" data-validation-minlength="0" name="address"></div></div>';
                ely.innerHTML += text;
            }
        }
    }
...
<ul class="breadcrumb">
    ...
    <li><i class="icon-dashboard"></i><a href="index.php/convergy/view"> My Assets</a> <span class="divider"><i class="icon-angle-right"></i></span></li>
...
<div class="row-fluid" >
    <div class="containerHeadline">
        <i class="icon-list-ol"></i><h2>Edit Asset</h2>
    ...
    <div class="floatingBox formWizard">
        <div class="container-fluid">
            ...
            <?php echo form_open('convergy/edit', array('enctype' => 'multipart/form-data', 'id' => 'formWizard', 'class' => 'form-horizontal', 'data-validate' => 'parsley')) ?>
            ...
            <fieldset>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input value="<?php echo $asset->title ?>" id="title" class="span10 parsley-validated" type="text" data-minlength="1"  data-required="true" data-trigger="change" data-validation-minlength="0" name="title">
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label" for="height">Measurement(Height) in meters *</label>
                    <div class="controls">
                        <input value="<?php echo $asset->hieght ?>" id="hieght"class="span10 parsley-validated" type="text" data-minlength="1" data-type="number" data-required="true" data-trigger="change" data-validation-minlength="0" name="hieght">
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label" for="width">Measurement(Width)in meters *</label>
                    <div class="controls">
                        <input value="<?php echo $asset->width ?>"  id="width" class="span10 parsley-validated" type="text" data-minlength="1" data-type="number" data-required="true" data-trigger="change" data-validation-minlength="0" name="width">
                    </div>
                </div>
                <div class="control-group">
                    ...
                    <div class="controls">
                       <?php
                        $list = array('Billboards' => 'Billboards', 'Mobile LED Vans' => 'Mobile LED Vans', 'Lampost' => 'Lampost', 'Street Furniture' => 'Street Furniture', 'Airport' => 'Airport', 'Rail' => 'Rail', 'Transit Vans' => 'Transit Vans', 'Cinema' => 'Cinema', 'Clubs' => 'Clubs', 'Gyms' => 'Gyms', 'Malls' => 'Malls', 'Mural' => 'Mural', 'Buses' => 'Buses', 'Taxis' => 'Taxis');
                    ...
                    <div class="controls">
                        <?php
                        $ads = array("Super 48 Sheet" => "Super 48 Sheet", "96 Sheet" => "96 Sheet", "Unipoles" => "Unipoles", "Portrait" => "Portrait", "Bulletin" => "Bulletin", "Backlit" => "Backlit", "Bridge Panel" => "Bridge Panel", "Long Banner" => "Long Banner", "Wall Panel" => "Wall Panel", "Inflatable" => "Inflatable", "Scrollers" => "Scrollers", "Trivision" => "Trivision");
              ...
              <!--  <div class="control-group" id="showy">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input value="<?php echo $asset->address ?>" id="address" class="span10 parsley-validated" type="text" data-minlength="1" data-required="true" data-trigger="change" data-validation-minlength="0" name="address">
                    </div>
                </div>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input value="<?php echo $asset->location_long ?>" id="location_long" class="span10 parsley-validated" type="text" data-minlength="1"  data-required="true" data-trigger="change" data-validation-minlength="0" name="location_long">
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label" for="location_lat">Location Latitude *</label>
                    <div class="controls">
                        <input value="<?php echo $asset->location_lat ?>" id="location_lat" class="span10 parsley-validated" type="text" data-minlength="1"  data-required="true" data-trigger="change" data-validation-minlength="0" name="location_lat">
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label" for="notes">Notes *</label>
                    <div class="controls">
                        <textarea value="" id="notes" class="span10 parsley-validated" data-minlength="1"  data-required="true" data-trigger="change" data-validation-minlength="0" name="notes"><?php echo $asset->notes ?></textarea>
                    </div>
                </div>
            </fieldset>
            <fieldset>
                <div class="control-group">
                    ...
                    <div class="controls">
                        <?php echo form_dropdown('currency', array('NGN (Nigeria)' => 'NGN (Nigeria)', '$USD (USA)' => '$USD (USA)'), $asset->currency, 'id = currency') ?>
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label" for="frequency">Rental Duration *</label>
                    <div class="controls">
                        <?php echo form_dropdown('frequency', array('Weekly' => 'Weekly', 'Monthly' => 'Monthly', 'Quarterly' => 'Quarterly', 'Bi-annually' => 'Bi-annually', 'Annually' => 'Annually'), $asset->frequency, 'id = frequency') ?>
                    </div>
                </div>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input value="<?php echo $asset->price ?>" id="price" class="span10 parsley-validated" type="text" data-minlength="1" data-type="number" data-required="true" data-trigger="change" data-validation-minlength="0" name="price">
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label" for="production">Production *</label>
                    <div class="controls">
                        <input value="<?php echo $asset->production ?>" id="production" class="span10 parsley-validated" type="text" data-minlength="1"  data-required="true" data-trigger="change" data-validation-minlength="0" name="production">
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label" for="posting">Posting *</label>
                    <div class="controls">
                        <input value="<?php echo $asset->posting ?>" id="posting" class="span10 parsley-validated" type="text" data-minlength="1"  data-required="true" data-trigger="change" data-validation-minlength="0" name="posting">
                    </div>
                </div>

                <div class="control-group">
                    <label class="control-label" for="trim_length">Trim Length *</label>
                    <div class="controls">
                        <input value="<?php echo $asset->trim_length ?>" id="trim_length" class="span10 parsley-validated" type="text" data-minlength="1" data-type="number" data-required="true" data-trigger="change" data-validation-minlength="0" name="trim_length">
                    </div>
                </div><div class="control-group">
                    <label class="control-label" for="trim_width">Trim Width *</label>
                    <div class="controls">
                        <input value="<?php echo $asset->trim_width ?>" id="trim_width" class="span10 parsley-validated" type="text" data-minlength="1" data-type="number" data-required="true" data-trigger="change" data-validation-minlength="0" name="trim_width">
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label" for="substrate">Substrate *</label>
                    <div class="controls">
                        <?php echo form_dropdown('substrate', array('Vinyl (SAV)' => 'Vinyl (SAV)', 'Flex' => 'Flex', 'Mesh' => 'Mesh'), $asset->substrate, 'id = substrate') ?>
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label" for="orientation">Orientation *</label>
                    <div class="controls">
                        <?php echo form_dropdown('orientation', array('Landscape)' => 'Landscape', 'Potrait' => 'Potrait'), $asset->orientation, 'id = orientation') ?>
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label" for="pro_notes">Production Notes *</label>
                    <div class="controls">
                        <textarea value="" id="pro_notes" class="span10 parsley-validated" data-minlength="1"  data-required="true" data-trigger="change" data-validation-minlength="0" name="pro_notes"><?php echo $asset->pro_notes ?></textarea>
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label" for="creative_advice">Creative Advice *</label>
                    <div class="controls">
                        <textarea value="" id="creative_advice" class="span10 parsley-validated" data-minlength="1"  data-required="true" data-trigger="change" data-validation-minlength="0" name="creative_advice"><?php echo $asset->creative_advice ?></textarea>
                    </div>
                </div>
            </fieldset>
            <!--<fieldset>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input value="<?php //echo $asset->upload ?>" type="file" id="userfile" name="userfile" class="span10 parsley-validated" data-minlength="1"  data-required="true" data-trigger="change" data-validation-minlength="0">
                    </div>
                </div>
                <!--<div class="control-group">
            ...
            <fieldset>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input value="<?php echo $asset->face ?>" id="face" class="span10 parsley-validated" type="text" data-minlength="1"  data-required="true" data-trigger="change" data-validation-minlength="0" name="face">
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label" for="approve_status">Approve Status *</label>
                    <div class="controls">
                        <?php echo form_dropdown('approve_status', array('Approved' => 'Approved', 'Not Approved' => 'Not Approved', 'Under Processing' => 'Under Processing'), $asset->approve_status, 'id = approve_status') ?>
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label" for="restriction">Restriction *</label>
                    <div class="controls">
                        <?php echo form_dropdown('restriction', array('None' => 'None', 'Minor' => 'Minor'), $asset->restriction, 'id = restriction') ?>
                    </div>
                </div>
                ...
                <div class="control-group">
                    ...
                    <?php 
                    echo form_hidden('review', $asset->id);
                    echo form_submit('submitForm', 'Click To Review Updated Asset');
                            ?>
                </div>
