...
<ul class="breadcrumb">
    <li><i class="icon-arrow-left"></i><a href=""> Back</a> <span class="divider"></span></li>
    ...
    if ($bks) :
        foreach ($bks as $bk):
            ...
            ?></td>
                                            ...
                                            if ($bk->campaign_id != 0): ?>
                                                <tr>
                                                    <td><i class="icon-pushpin"></i><a href="index.php/convergy/add/<?php echo $eid.'/'.$face_id ?>"> Book This Asset</a></td>
